...
class TestGrainProcedureBasic(ProcedureBase):
  key: ClassVar[str] = "test_grain_procedure_basic"
  ...
  description: ClassVar[str] = "Run all basic pytest suites (grain, procedure)"
